defmodule WebtritAdapterClient do
  ...
  def new(adapter_url, tenant_id \\ nil, access_token \\ nil) do
    ...
    middleware =
      ...
      |> then(&[WebtritAdapterClient.Tesla.Middleware.RequestId | &1])
...
defmodule WebtritAdapterClient.Tesla.Middleware.RequestId do
  ...
  defp generate_request_id(opts) do
    request_id_prefix = Keyword.get(opts, :prefix, "WAC/")
